...
window.SITE_DATA = {
  hero: { eyebrow: "Area Studies CLUB", title: "世界を知ることへのワクワクと、楽しさを。", body: "青山学院大学 地域研究愛好会 公式ホームページへようこそ。\n本会では「地域研究」をテーマに、言語学、地理学、民俗学、歴史学などの学問を軸に、研究し、発信し、世界を知る活動を行っています。" },
  news: [
  ...
  activities: {
    ...
    extra: [
      { lead: "外国語の勉強会を開催したり 外国料理を食べに行ったり", highlight: "多岐にわたる活動を実施しております" }
    ],
    note: ""
  },
